...
export default function NewOrder() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!form.supplier_id || !form.material || !form.quantity) {
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-[40px] shadow-sm border border-slate-100 p-10 flex flex-col gap-8 relative overflow-hidden">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <select 
                ...
                onChange={(e) => {
                  const selectedSupplier = suppliers.find((s) => String(s.id) === e.target.value);
                  setForm({
                    ...form,
                    supplier_id: e.target.value,
                    customer: selectedSupplier ? selectedSupplier.name : ''
                  });
                }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2.5">
                <label className="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Estimated Arrival</label>
                <input 
                  type="date"
                  value={form.eta_date}
